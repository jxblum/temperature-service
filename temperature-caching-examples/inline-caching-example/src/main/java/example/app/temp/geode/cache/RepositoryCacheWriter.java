...
import example.app.temp.util.function.FunctionUtils;
 ...
 * @see example.app.temp.geode.cache.support.CacheWriterSupport
...
public class RepositoryCacheWriter<T, ID> extends RepositoryCacheLoaderWriterSupport<T, ID> {
  ...
  public void beforeRegionDestroy(RegionEvent<ID, T> event) throws CacheWriterException {
    // TODO: perhaps implement releasing any external data source resources
